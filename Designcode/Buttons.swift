...
//  Designcode
//
//  Created by Curtis Lee on 17/03/2021.
//
...
struct RectangleButton: View {
    ...
    var body: some View {
        Text("Button")
            ...
            // Two gesture effects. Quick tap effect (scale), as well as the Long press effects
        .gesture(
            LongPressGesture(minimumDuration: 0.5, maximumDistance: 10).onChanged { value in
                self.tap = true
                // Set a delay of 0.1, with .now() being the present active state
