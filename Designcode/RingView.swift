...
struct RingView: View {
    ...
    var width: CGFloat = 88 // Expects width (and height) to be a CGFloat, so we must specific here in order to use use in .frame()
    ...
    var body: some View {
        ...
        let progress = 1 - percent / 100 // 1 is the whole number, minus the percent out of 100
